...
async function main() {
    ...
    try {
        ...
        const [explain] = await connection.execute(
            'EXPLAIN SELECT * FROM tblListaPreciosHistorial WHERE IdZona = 1 AND Dia = 15 AND Mes = 11 AND Anio = 2016 AND IdArticulo = 1567'
        );
        console.log('EXPLAIN POINT LOOKUP RESULT:');
        console.log(explain);
